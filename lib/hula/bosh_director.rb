...
module Hula
  class BoshDirector
    ...
    attr_reader :target_url, :username, :password, :command_runner, :logger, :certificate_path, :gateway_opts
    ...
    def target_and_login
      ...
      # TODO: we must always provide BOSH_CLIENT and BOSH_CLIENT_SECRET
